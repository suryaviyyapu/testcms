...
function error_check() {
    ...
    if(version_compare(VERSION, ($version = latest_version()), '<')) {
        $errors[] = 'Your version of Test CMS is out of date. Please <a href="http://google.com">download the latest version</a>.';
    }
...
function execution_time() {
	$miliseconds = microtime(true) - START;
