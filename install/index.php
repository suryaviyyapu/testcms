...
<html lang="en-gb">
    <head>
        <meta charset="utf-8">
        <title>Install Test CMS CMS</title>
    ...
    <body>
    	...
    	*/
    	...
    	if(version_compare(PHP_VERSION, '5.3.0', '<')) {
    		$compat[] = 'Test CMS requires PHP 5.3 or newer.<br><em>Your current environment is running PHP ' . PHP_VERSION . '</em>';
    	}
    	
    	// PDO
    	if(class_exists('PDO') === false) {
    		$compat[] = 'Test CMS requires PDO (PHP Data Objects)<br>
    		...
    		if(in_array('mysql', PDO::getAvailableDrivers()) === false) {
    			$compat[] = 'Test CMS requires the MySQL PDO Driver<br>
    	...
    	<div class="content">
    		...
    		<p>Test CMS is missing some requirements:</p>
    	...
    	<div class="content">
    		...
    		<p>Test CMS is already installed. You should really delete this folder!</p>
            ...
            <form method="get" novalidate>
                <fieldset id="diagnose">
                    ...
                    <p>
                        ...
                        <input id="db" autocapitalize="off" name="db" placeholder="Test CMS">
                    </p>
                ...
                <fieldset>
                    ...
                    <p>
                        ...
                        <input id="name" name="name" placeholder="My awesome Test CMS site">
                    </p>
                ...
                <br style="clear: both;">
                <button type="submit">Install Test CMS</button>
            </form>
        </div>
